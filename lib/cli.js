...
Examples:
  ...
  mrscraper scrape "https://books.toscrape.com/" --prompt "Extract every book"
...
export async function runCli(argv = process.argv) {
  ...
  program
    .command("init")
    .description("Install the CLI, authenticate, and add the skill to detected agents.")
    .option("--api-key <key>", "API key non-interactively; otherwise prompt.")
    .option("--all", "Install the skill for every detected agent harness (default).")
    .option(
      "--agent <name>",
      "Install the skill for one agent harness.",
    ...
    .option("--skip-skills", "Do not install the agent skill.")
  ...
  setup
    .command("skills")
    .description("Install the MrScraper skill for detected agent harnesses.")
