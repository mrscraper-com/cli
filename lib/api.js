...
export const API_BASE_URL =
  process.env.MRSCRAPER_API_URL || "https://api.app.mrscraper.com/api/v1";
...
export const APP_BASE_URL =
  process.env.MRSCRAPER_APP_URL || "https://app.mrscraper.com";
...
/**
 * Exchange a single-use browser-login code (plus the PKCE verifier that
 * proves this CLI initiated the login) for the API token.
 * @param {{ code: string, codeVerifier: string }} p
 */
export async function exchangeCliCodeApi({ code, codeVerifier }) {
  return request("POST", `${API_BASE_URL}/auth/cli/exchange`, {
